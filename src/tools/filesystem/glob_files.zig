...
test "glob_files permission denied directory returns structured recovery" {
    ...
    std.Io.Dir.cwd().setFilePermissions(io_mod.getIo(), blocked, io_mod.permissionsFromUnixMode(0), .{}) catch return error.SkipZigTest;
    defer std.Io.Dir.cwd().setFilePermissions(io_mod.getIo(), blocked, io_mod.permissionsFromUnixMode(0o700), .{}) catch {};
