...
pub const top_level_specs = [_]TopLevelSpec{
    ...
    .{
        ...
        .summary = "Configure an OpenAI-compatible Chat Completions URL and API key",
        .details = &.{
            "With no arguments, or with `openai-compatible`, save a Chat Completions base URL and API key.",
            "Point this at any OpenAI-compatible server, including a local or hosted subscription proxy.",
        },
    },
    .{
        .kind = .status,
