...
const openai_compatible_builtin = @import("providers/openai_compatible.zig");
...
pub const native = provider_set.Set{
    ...
    .openai_compatible = .{
        ...
        .agent_stream = openai_compatible_builtin.agent_stream_provider_value,
        .cli_model_catalog = openai_compatible_builtin.cli_model_catalog_provider,
        .model_catalog = openai_compatible_builtin.model_catalog_provider,
        .credits = openai_compatible_builtin.credits_provider,
    },
};
